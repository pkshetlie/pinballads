...
class Product
{
    ...
    private ?string $otherManufacturer = null;
    ...
    public function getOtherManufacturer(): ?string
    {
        return $this->otherManufacturer;
    }

    public function setOtherManufacturer(?string $otherManufacturer): static
    {
